...
// Incase If to use SVG, use the line below
// import { SvgUri } from "react-native-svg";
import ImageZoom from "react-native-image-pan-zoom";
import { supabase } from "../../lib/supabase";

const BUCKET = "assets";
const KEY = "maps/londonderry-map-isolated-reduced.png";
...
export default function MapPage() {
    ...
    const contentW = useMemo(
        () => (contentH ? Math.round(contentH * MAP_RATIO) : 0),
        [contentH],
    );
        ...
        () => [
            {
                ...
                x: 0.46,
                y: 0.41,
                label: "Community Center Room Directory\n- Activities Room\n- Tred Avon Tavern\n- Living Room\n- Sunroom\n- 1st Floor Alcove (Apartment Building)",
            },
            {
                id: "m2",
                x: 0.63,
                y: 0.6,
                label: "Clubhouse Room Directory\n- Craft Room\n- Sitting Room\n- Multi-Purpose Room\n- Salon\n- Sales and Marketing Office\n- Catering Kitchen\n- Conference Room\n- Gym",
            },
            {
                id: "m3",
                x: 0.76,
                y: 0.24,
                label: "Magnolia Manor Room Directory\n- Billiards Room\n- Pinkney Suite\n- Rhodes Suite\n- Armstrong Suite",
            },
        ],
        [],
    );
        ...
        >
            {!cropW || !cropH || !contentW || !contentH ? (
                ...
                >
                    ...
                    >
                        {/* Map */}
                        {/* Incase I have to use SVG, use below */}
