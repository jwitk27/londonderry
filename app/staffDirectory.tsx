...
export default function StaffDirectoryScreen() {
    ...
    const load = async () => {
        const { data, error } = await supabase
            .from("staff_members")
            .select(
                "id,name,role_title,phone,email,photo_url,sort_order,created_at",
            )
            ...
            { text: "Cancel", style: "cancel" },
            {
                ...
                onPress: async () => {
                    const { error } = await supabase
                        ...
                        .eq("id", s.id);
                    if (error)
                        return Alert.alert("Delete failed", error.message);
                    load();
                },
            },
        ]);
        ...
        <View style={styles.screen}>
            ...
            <Modal visible={modalOpen} transparent animationType="fade">
                <Pressable
                    ...
                    onPress={() => (!saving ? setModalOpen(false) : null)}
                >
